---
okf_version: 0.2
title: "ADR-0010: One-file and split screen formats"
summary: "Support both a single .screen.tsx file and feature-local controller/view separation, normalized to one manifest."
type: decision
status: accepted
---

# ADR-0010: One-file and split screen formats
...
Support both a single .screen.tsx file and feature-local controller/view separation, normalized to one manifest.

## Rationale

Simple screens stay concise while complex workflows retain testable boundaries without two runtimes.
