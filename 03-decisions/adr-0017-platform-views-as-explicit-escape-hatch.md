---
okf_version: 0.2
title: "ADR-0017: Platform views as explicit escape hatch"
summary: "Support native platform views with documented composition and accessibility limits."
type: decision
status: accepted
---

# ADR-0017: Platform views as explicit escape hatch
...
Support native platform views with documented composition and accessibility limits.

## Rationale

Maps, web content, and camera surfaces cannot always be recreated credibly through Skia.
