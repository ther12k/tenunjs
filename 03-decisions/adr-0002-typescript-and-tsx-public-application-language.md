---
okf_version: 0.2
title: "ADR-0002: TypeScript and TSX public application language"
summary: "Use strict TypeScript and TSX as the public application language."
type: decision
status: accepted
---

# ADR-0002: TypeScript and TSX public application language
...
Use strict TypeScript and TSX as the public application language.

## Rationale

This matches the intended developer audience and keeps native implementation languages behind framework contracts.
