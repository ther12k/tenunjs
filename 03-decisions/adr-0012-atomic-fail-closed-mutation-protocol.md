---
okf_version: 0.2
title: "ADR-0012: Atomic fail-closed mutation protocol"
summary: "Validate complete versioned mutation buffers before applying any scene change."
type: decision
status: accepted
---

# ADR-0012: Atomic fail-closed mutation protocol
...
Validate complete versioned mutation buffers before applying any scene change.

## Rationale

A native engine must never be corrupted by malformed, stale, or partially applied JS operations.
