---
okf_version: 0.2
title: "ADR-0013: Native scrolling and animation"
summary: "Keep scroll physics and per-frame animation evaluation in the native engine."
type: decision
status: accepted
---

# ADR-0013: Native scrolling and animation
...
Keep scroll physics and per-frame animation evaluation in the native engine.

## Rationale

Motion must continue during short JavaScript stalls and should not require a bridge round trip every frame.
