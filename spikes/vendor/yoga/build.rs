...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .allowlist_var("YG.*")
        // review-5: YGUndefined binds as `f64::NAN` against an f32 const on
        // some libclang versions, breaking compilation; the spike adapter
        // defines its own NAN and never reads this constant.
        .blocklist_item("YGUndefined")
        .layout_tests(false)
