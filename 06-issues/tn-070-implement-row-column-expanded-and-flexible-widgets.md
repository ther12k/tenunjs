---
okf_version: 0.2
title: "TN-070: Implement Row, Column, Expanded, and Flexible widgets"
summary: "Flutter-inspired flex composition maps predictably to the selected layout backend."
type: issue
status: ready
issue_id: "TN-070"
milestone: "M4"
...
# TN-070 — Implement Row, Column, Expanded, and Flexible widgets
...
| Priority | P0 |
| Dependencies | TN-040, TN-069 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Flutter-inspired flex composition maps predictably to the selected layout backend.
...
[TN-040](tn-040-implement-selected-layout-adapter.md), [TN-069](tn-069-implement-view-text-fragment-and-spacer-host-widgets.md)
...
2. Write a short implementation note that states how this issue will produce: **Flutter-inspired flex composition maps predictably to the selected layout backend.**
...
- [ ] **Primary outcome:** Flutter-inspired flex composition maps predictably to the selected layout backend.
