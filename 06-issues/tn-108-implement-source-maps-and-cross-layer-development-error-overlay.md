---
okf_version: 0.2
title: "TN-108: Implement source maps and cross-layer development error overlay"
summary: "JS/native errors point to actionable source and do not conceal the owning failure layer."
type: issue
status: ready
issue_id: "TN-108"
milestone: "M6"
...
# TN-108 — Implement source maps and cross-layer development error overlay
...
| Priority | P0 |
| Dependencies | TN-023, TN-030, TN-031, TN-107 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

JS/native errors point to actionable source and do not conceal the owning failure layer.
...
[TN-023](tn-023-implement-runtime-compatible-bundle-or-bytecode-compiler.md), [TN-030](tn-030-implement-cross-layer-structured-error-codes-and-crash-boundaries.md), [TN-031](tn-031-implement-unified-development-log-transport.md), [TN-107](tn-107-implement-development-bundle-server-and-fast-refresh-protocol.md)
...
2. Write a short implementation note that states how this issue will produce: **JS/native errors point to actionable source and do not conceal the owning failure layer.**
...
7. Design stable command/output contracts and machine-readable errors before UI polish.
8. Exercise clean checkout, paths with spaces, offline cache, multiple devices, cancellation, and partial failure.
9. Ensure release builds exclude development transports and inspectors.
...
- [ ] **Primary outcome:** JS/native errors point to actionable source and do not conceal the owning failure layer.
