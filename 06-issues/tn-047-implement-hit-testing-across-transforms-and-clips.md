---
okf_version: 0.2
title: "TN-047: Implement hit testing across transforms and clips"
summary: "Pointer targets and hit paths match layout, clipping, visibility, and z-order."
type: issue
status: ready
issue_id: "TN-047"
milestone: "M2"
...
# TN-047 — Implement hit testing across transforms and clips
...
| Priority | P0 |
| Dependencies | TN-038, TN-040 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Pointer targets and hit paths match layout, clipping, visibility, and z-order.
...
[TN-038](tn-038-implement-atomic-scene-tree-transaction-application.md), [TN-040](tn-040-implement-selected-layout-adapter.md)
...
2. Write a short implementation note that states how this issue will produce: **Pointer targets and hit paths match layout, clipping, visibility, and z-order.**
...
- [ ] **Primary outcome:** Pointer targets and hit paths match layout, clipping, visibility, and z-order.
