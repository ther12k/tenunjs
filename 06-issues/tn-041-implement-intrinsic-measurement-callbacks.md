---
okf_version: 0.2
title: "TN-041: Implement intrinsic measurement callbacks"
summary: "Text, images, and platform placeholders can measure under bounded constraints."
type: issue
status: ready
issue_id: "TN-041"
milestone: "M2"
...
# TN-041 — Implement intrinsic measurement callbacks
...
Text, images, and platform placeholders can measure under bounded constraints.
...
[TN-040](tn-040-implement-selected-layout-adapter.md)
...
2. Write a short implementation note that states how this issue will produce: **Text, images, and platform placeholders can measure under bounded constraints.**
...
- [ ] **Primary outcome:** Text, images, and platform placeholders can measure under bounded constraints.
