---
okf_version: 0.2
title: "TN-045: Implement Skia display-list playback"
summary: "Core transforms, clips, opacity, rounded rectangles, paths, images, and text placeholders render identically."
type: issue
status: ready
issue_id: "TN-045"
milestone: "M2"
...
# TN-045 — Implement Skia display-list playback
...
| Priority | P0 |
| Dependencies | TN-042, TN-043, TN-044 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Core transforms, clips, opacity, rounded rectangles, paths, images, and text placeholders render identically.
...
[TN-042](tn-042-implement-renderer-neutral-display-list.md), [TN-043](tn-043-implement-ios-skia-gpu-surface-and-lifecycle.md), [TN-044](tn-044-implement-android-skia-gpu-surface-and-fallback-policy.md)
...
2. Write a short implementation note that states how this issue will produce: **Core transforms, clips, opacity, rounded rectangles, paths, images, and text placeholders render identically.**
...
- [ ] **Primary outcome:** Core transforms, clips, opacity, rounded rectangles, paths, images, and text placeholders render identically.
