---
okf_version: 0.2
title: "TN-090: Implement iOS VoiceOver bridge and focus synchronization"
summary: "Core widgets, navigation, dialogs, actions, and live announcements work with VoiceOver."
type: issue
status: ready
issue_id: "TN-090"
milestone: "M5"
...
# TN-090 — Implement iOS VoiceOver bridge and focus synchronization
...
| Priority | P0 |
| Dependencies | TN-026, TN-077, TN-089 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Core widgets, navigation, dialogs, actions, and live announcements work with VoiceOver.
...
[TN-026](tn-026-implement-ios-application-embedder-shell.md), [TN-077](tn-077-implement-ios-text-input-and-ime-adapter.md), [TN-089](tn-089-implement-semantics-node-model-and-scene-projection.md)
...
2. Write a short implementation note that states how this issue will produce: **Core widgets, navigation, dialogs, actions, and live announcements work with VoiceOver.**
...
- [ ] **Primary outcome:** Core widgets, navigation, dialogs, actions, and live announcements work with VoiceOver.
