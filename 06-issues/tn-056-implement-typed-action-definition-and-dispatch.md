---
okf_version: 0.2
title: "TN-056: Implement typed action definition and dispatch"
summary: "Events dispatch statically registered typed actions with validated payloads."
type: issue
status: ready
issue_id: "TN-056"
milestone: "M3"
...
# TN-056 — Implement typed action definition and dispatch
...
[TN-053](tn-053-implement-property-diffing-and-event-handle-registration.md), [TN-055](tn-055-implement-controller-definition-and-typed-state-initialization.md)
...
2. Write a short implementation note that states how this issue will produce: **Events dispatch statically registered typed actions with validated payloads.**
...
- [ ] **Primary outcome:** Events dispatch statically registered typed actions with validated payloads.
