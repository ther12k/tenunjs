---
okf_version: 0.2
title: "TN-105: Implement create-tenun and project generation CLI"
summary: "One command creates a valid app with iOS/Android projects and a working sample screen."
type: issue
status: ready
issue_id: "TN-105"
milestone: "M6"
...
# TN-105 — Implement create-tenun and project generation CLI
...
| Priority | P0 |
| Dependencies | TN-019, TN-021, TN-102, TN-103 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

One command creates a valid app with iOS/Android projects and a working sample screen.
...
[TN-019](tn-019-create-typescript-package-workspace-and-strict-configuration.md), [TN-021](tn-021-implement-project-configuration-schema-and-loader.md), [TN-102](tn-102-implement-ios-framework-packaging-symbols-and-sample-app-assembly.md), [TN-103](tn-103-implement-android-library-packaging-symbols-and-sample-app-assembly.md)
...
2. Write a short implementation note that states how this issue will produce: **One command creates a valid app with iOS/Android projects and a working sample screen.**
...
4. Design stable command/output contracts and machine-readable errors before UI polish.
5. Exercise clean checkout, paths with spaces, offline cache, multiple devices, cancellation, and partial failure.
6. Ensure release builds exclude development transports and inspectors.
...
- [ ] **Primary outcome:** One command creates a valid app with iOS/Android projects and a working sample screen.
