---
okf_version: 0.2
title: "TN-058: Implement cancellable async effects and concurrency policies"
summary: "Latest/drop/queue/parallel policies are bounded and stale completions cannot mutate disposed state."
type: issue
status: ready
issue_id: "TN-058"
milestone: "M3"
...
# TN-058 — Implement cancellable async effects and concurrency policies
...
| Priority | P0 |
| Dependencies | TN-056, TN-057 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Latest/drop/queue/parallel policies are bounded and stale completions cannot mutate disposed state.
...
[TN-056](tn-056-implement-typed-action-definition-and-dispatch.md), [TN-057](tn-057-implement-atomic-controller-state-transactions.md)
...
2. Write a short implementation note that states how this issue will produce: **Latest/drop/queue/parallel policies are bounded and stale completions cannot mutate disposed state.**
...
- [ ] **Primary outcome:** Latest/drop/queue/parallel policies are bounded and stale completions cannot mutate disposed state.
