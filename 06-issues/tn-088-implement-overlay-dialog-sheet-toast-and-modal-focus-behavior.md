---
okf_version: 0.2
title: "TN-088: Implement Overlay, Dialog, Sheet, Toast, and modal focus behavior"
summary: "Layering, dismissal, back handling, accessibility focus, and safe areas behave on both platforms."
type: issue
status: ready
issue_id: "TN-088"
milestone: "M4"
...
# TN-088 — Implement Overlay, Dialog, Sheet, Toast, and modal focus behavior
...
| Priority | P0 |
| Dependencies | TN-063, TN-072, TN-073, TN-081, TN-087 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Layering, dismissal, back handling, accessibility focus, and safe areas behave on both platforms.
...
[TN-063](tn-063-implement-stack-navigation-and-screen-lifecycle.md), [TN-072](tn-072-implement-safearea-scaffold-appbar-and-page-shell-widgets.md), [TN-073](tn-073-implement-pressable-button-iconbutton-and-interaction-states.md), [TN-081](tn-081-implement-native-focus-tree-scopes-traversal-and-restoration.md), [TN-087](tn-087-implement-animated-widgets-transitions-and-layout-invalidation-rules.md)
...
2. Write a short implementation note that states how this issue will produce: **Layering, dismissal, back handling, accessibility focus, and safe areas behave on both platforms.**
...
- [ ] **Primary outcome:** Layering, dismissal, back handling, accessibility focus, and safe areas behave on both platforms.
