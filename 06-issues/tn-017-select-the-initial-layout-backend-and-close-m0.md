---
okf_version: 0.2
title: "TN-017: Select the initial layout backend and close M0"
summary: "Accepted layout decision and complete M0 architecture packet with no unresolved foundational choice."
type: issue
status: ready
issue_id: "TN-017"
milestone: "M0"
...
# TN-017 — Select the initial layout backend and close M0
...
| Priority | P0 |
| Dependencies | TN-009, TN-013, TN-015, TN-016 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Accepted layout decision and complete M0 architecture packet with no unresolved foundational choice.
...
[TN-009](tn-009-score-and-select-the-initial-native-engine-language.md), [TN-013](tn-013-select-the-initial-embedded-javascript-runtime.md), [TN-015](tn-015-implement-yoga-layout-spike.md), [TN-016](tn-016-implement-taffy-layout-spike.md)
...
2. Write a short implementation note that states how this issue will produce: **Accepted layout decision and complete M0 architecture packet with no unresolved foundational choice.**
...
10. Model route parameters as validated untrusted inputs and state transitions as effects.
11. Cover push/replace/pop, modal, back gesture, interruption, process recreation, and invalid snapshots.
12. Verify controller creation/disposal and focus restoration around every transition.
...
- [ ] **Primary outcome:** Accepted layout decision and complete M0 architecture packet with no unresolved foundational choice.
