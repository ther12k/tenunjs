---
okf_version: 0.2
title: "TN-062: Specify typed route and navigation state model"
summary: "Route schemas, stack entries, modal entries, and restoration metadata are versioned."
type: issue
status: ready
issue_id: "TN-062"
milestone: "M3"
...
# TN-062 — Specify typed route and navigation state model
...
[TN-002](tn-002-freeze-product-charter-target-workload-and-non-goals.md), [TN-055](tn-055-implement-controller-definition-and-typed-state-initialization.md)
...
2. Write a short implementation note that states how this issue will produce: **Route schemas, stack entries, modal entries, and restoration metadata are versioned.**
...
- [ ] **Primary outcome:** Route schemas, stack entries, modal entries, and restoration metadata are versioned.
