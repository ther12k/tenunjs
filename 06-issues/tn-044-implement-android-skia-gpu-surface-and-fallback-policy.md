---
okf_version: 0.2
title: "TN-044: Implement Android Skia GPU surface and fallback policy"
summary: "Vulkan or measured fallback surface handles resize and context lifecycle."
type: issue
status: ready
issue_id: "TN-044"
milestone: "M2"
...
# TN-044 — Implement Android Skia GPU surface and fallback policy
...
| Priority | P0 |
| Dependencies | TN-027, TN-042 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Vulkan or measured fallback surface handles resize and context lifecycle.
...
[TN-027](tn-027-implement-android-application-embedder-shell.md), [TN-042](tn-042-implement-renderer-neutral-display-list.md)
...
2. Write a short implementation note that states how this issue will produce: **Vulkan or measured fallback surface handles resize and context lifecycle.**
...
- [ ] **Primary outcome:** Vulkan or measured fallback surface handles resize and context lifecycle.
