---
okf_version: 0.2
title: "TN-077: Implement iOS text input and IME adapter"
summary: "Typing, composition, selection, secure entry, autofill, and keyboard geometry work on device."
type: issue
status: ready
issue_id: "TN-077"
milestone: "M4"
...
# TN-077 — Implement iOS text input and IME adapter
...
| Priority | P0 |
| Dependencies | TN-026, TN-043, TN-076 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Typing, composition, selection, secure entry, autofill, and keyboard geometry work on device.
...
[TN-026](tn-026-implement-ios-application-embedder-shell.md), [TN-043](tn-043-implement-ios-skia-gpu-surface-and-lifecycle.md), [TN-076](tn-076-implement-editable-text-model-and-revision-protocol.md)
...
2. Write a short implementation note that states how this issue will produce: **Typing, composition, selection, secure entry, autofill, and keyboard geometry work on device.**
...
- [ ] **Primary outcome:** Typing, composition, selection, secure entry, autofill, and keyboard geometry work on device.
