---
okf_version: 0.2
title: "TN-076: Implement editable text model and revision protocol"
summary: "Text, composing range, selection, commands, and controller synchronization are revision-safe."
type: issue
status: ready
issue_id: "TN-076"
milestone: "M4"
...
# TN-076 — Implement editable text model and revision protocol
...
| Priority | P0 |
| Dependencies | TN-055, TN-075 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Text, composing range, selection, commands, and controller synchronization are revision-safe.
...
[TN-055](tn-055-implement-controller-definition-and-typed-state-initialization.md), [TN-075](tn-075-implement-text-shaping-paragraph-layout-and-font-fallback-service.md)
...
2. Write a short implementation note that states how this issue will produce: **Text, composing range, selection, commands, and controller synchronization are revision-safe.**
...
- [ ] **Primary outcome:** Text, composing range, selection, commands, and controller synchronization are revision-safe.
