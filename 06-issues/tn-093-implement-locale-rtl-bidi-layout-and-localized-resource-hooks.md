---
okf_version: 0.2
title: "TN-093: Implement locale, RTL, bidi layout, and localized resource hooks"
summary: "Locale changes, mirrored layout, mixed-direction text, and formatted resources pass fixtures."
type: issue
status: ready
issue_id: "TN-093"
milestone: "M5"
...
# TN-093 — Implement locale, RTL, bidi layout, and localized resource hooks
...
| Priority | P1 |
| Dependencies | TN-040, TN-068, TN-075, TN-089 |
| Suggested size | One focused worktree and PR |
| Gate impact | Required supporting work |

## Required outcome

Locale changes, mirrored layout, mixed-direction text, and formatted resources pass fixtures.
...
[TN-040](tn-040-implement-selected-layout-adapter.md), [TN-068](tn-068-implement-theme-tokens-and-inherited-widget-context.md), [TN-075](tn-075-implement-text-shaping-paragraph-layout-and-font-fallback-service.md), [TN-089](tn-089-implement-semantics-node-model-and-scene-projection.md)
...
2. Write a short implementation note that states how this issue will produce: **Locale changes, mirrored layout, mixed-direction text, and formatted resources pass fixtures.**
...
- [ ] **Primary outcome:** Locale changes, mirrored layout, mixed-direction text, and formatted resources pass fixtures.
