---
okf_version: 0.2
title: "TN-098: Generate TypeScript, engine, Swift, Kotlin, and mock native-module bindings"
summary: "One schema generates compileable bindings and compatibility tests."
type: issue
status: ready
issue_id: "TN-098"
milestone: "M5"
...
# TN-098 — Generate TypeScript, engine, Swift, Kotlin, and mock native-module bindings
...
| Priority | P0 |
| Dependencies | TN-019, TN-097 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

One schema generates compileable bindings and compatibility tests.
...
[TN-019](tn-019-create-typescript-package-workspace-and-strict-configuration.md), [TN-097](tn-097-specify-native-module-idl-and-compatibility-manifest.md)
...
2. Write a short implementation note that states how this issue will produce: **One schema generates compileable bindings and compatibility tests.**
...
- [ ] **Primary outcome:** One schema generates compileable bindings and compatibility tests.
