---
okf_version: 0.2
title: "TN-040: Implement selected layout adapter"
summary: "Native scene nodes map to selected layout backend with lifecycle-safe ownership."
type: issue
status: ready
issue_id: "TN-040"
milestone: "M2"
...
# TN-040 — Implement selected layout adapter
...
| Priority | P0 |
| Dependencies | TN-017, TN-034, TN-038 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Native scene nodes map to selected layout backend with lifecycle-safe ownership.
...
[TN-017](tn-017-select-the-initial-layout-backend-and-close-m0.md), [TN-034](tn-034-implement-host-widget-kind-and-property-schema-registry.md), [TN-038](tn-038-implement-atomic-scene-tree-transaction-application.md)
...
2. Write a short implementation note that states how this issue will produce: **Native scene nodes map to selected layout backend with lifecycle-safe ownership.**
...
- [ ] **Primary outcome:** Native scene nodes map to selected layout backend with lifecycle-safe ownership.
