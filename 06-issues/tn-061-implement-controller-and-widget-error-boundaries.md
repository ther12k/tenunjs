---
okf_version: 0.2
title: "TN-061: Implement controller and widget error boundaries"
summary: "Recoverable view/action failures render declared fallbacks and cancel owned effects."
type: issue
status: ready
issue_id: "TN-061"
milestone: "M3"
...
# TN-061 — Implement controller and widget error boundaries
...
| Priority | P1 |
| Dependencies | TN-030, TN-054, TN-058 |
| Suggested size | One focused worktree and PR |
| Gate impact | Required supporting work |

## Required outcome

Recoverable view/action failures render declared fallbacks and cancel owned effects.
...
[TN-030](tn-030-implement-cross-layer-structured-error-codes-and-crash-boundaries.md), [TN-054](tn-054-implement-root-scheduling-and-bounded-reconciliation.md), [TN-058](tn-058-implement-cancellable-async-effects-and-concurrency-policies.md)
...
2. Write a short implementation note that states how this issue will produce: **Recoverable view/action failures render declared fallbacks and cancel owned effects.**
...
- [ ] **Primary outcome:** Recoverable view/action failures render declared fallbacks and cancel owned effects.
