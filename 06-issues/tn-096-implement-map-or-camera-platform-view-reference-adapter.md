---
okf_version: 0.2
title: "TN-096: Implement map or camera platform-view reference adapter"
summary: "A graphics-heavy native view proves surface/lifecycle and interaction limits."
type: issue
status: ready
issue_id: "TN-096"
milestone: "M5"
...
# TN-096 — Implement map or camera platform-view reference adapter
...
A graphics-heavy native view proves surface/lifecycle and interaction limits.
...
2. Write a short implementation note that states how this issue will produce: **A graphics-heavy native view proves surface/lifecycle and interaction limits.**
...
- [ ] **Primary outcome:** A graphics-heavy native view proves surface/lifecycle and interaction limits.
