---
okf_version: 0.2
title: "TN-018: Create selected native engine build workspace"
summary: "Selected toolchain builds shared core and empty renderer artifacts reproducibly."
type: issue
status: ready
issue_id: "TN-018"
milestone: "M1"
...
# TN-018 — Create selected native engine build workspace
...
Selected toolchain builds shared core and empty renderer artifacts reproducibly.
...
[TN-017](tn-017-select-the-initial-layout-backend-and-close-m0.md)
...
2. Write a short implementation note that states how this issue will produce: **Selected toolchain builds shared core and empty renderer artifacts reproducibly.**
...
- [ ] **Primary outcome:** Selected toolchain builds shared core and empty renderer artifacts reproducibly.
