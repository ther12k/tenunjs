---
okf_version: 0.2
title: "TN-073: Implement Pressable, Button, IconButton, and interaction states"
summary: "Touch, keyboard, disabled, pressed, focus, and semantic actions share one action path."
type: issue
status: ready
issue_id: "TN-073"
milestone: "M4"
...
# TN-073 — Implement Pressable, Button, IconButton, and interaction states
...
| Priority | P0 |
| Dependencies | TN-047, TN-056, TN-068, TN-069 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Touch, keyboard, disabled, pressed, focus, and semantic actions share one action path.
...
[TN-047](tn-047-implement-hit-testing-across-transforms-and-clips.md), [TN-056](tn-056-implement-typed-action-definition-and-dispatch.md), [TN-068](tn-068-implement-theme-tokens-and-inherited-widget-context.md), [TN-069](tn-069-implement-view-text-fragment-and-spacer-host-widgets.md)
...
2. Write a short implementation note that states how this issue will produce: **Touch, keyboard, disabled, pressed, focus, and semantic actions share one action path.**
...
- [ ] **Primary outcome:** Touch, keyboard, disabled, pressed, focus, and semantic actions share one action path.
