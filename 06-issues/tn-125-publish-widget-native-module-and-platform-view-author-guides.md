---
okf_version: 0.2
title: "TN-125: Publish widget, native-module, and platform-view author guides"
summary: "Extension authors have supported contracts, templates, tests, and compatibility rules."
type: issue
status: ready
issue_id: "TN-125"
milestone: "M7"
...
# TN-125 — Publish widget, native-module, and platform-view author guides
...
| Priority | P1 |
| Dependencies | TN-098, TN-094, TN-122, TN-123 |
| Suggested size | One focused worktree and PR |
| Gate impact | Required supporting work |

## Required outcome

Extension authors have supported contracts, templates, tests, and compatibility rules.
...
[TN-098](tn-098-generate-typescript-engine-swift-kotlin-and-mock-native-module-bindings.md), [TN-094](tn-094-specify-platform-view-lifecycle-and-composition-contract.md), [TN-122](tn-122-review-and-simplify-public-api-from-pilot-evidence.md), [TN-123](tn-123-freeze-package-boundaries-versioning-and-compatibility-policy.md)
...
2. Write a short implementation note that states how this issue will produce: **Extension authors have supported contracts, templates, tests, and compatibility rules.**
...
7. Version the capability and lifecycle contract; prohibit arbitrary native invocation.
8. Generate or test TypeScript, native, and mock sides together with mismatch failures.
9. Cover permission denial, cancellation, backgrounding, recreation, focus, and disposal.
10. Define entrance/exit criteria, owners, evidence locations, known limitations, and rollback before declaring success.
11. Use a clean consumer project rather than relying only on framework-repository examples.
12. Verify all documented commands and code against the exact release artifacts.
...
- [ ] **Primary outcome:** Extension authors have supported contracts, templates, tests, and compatibility rules.
