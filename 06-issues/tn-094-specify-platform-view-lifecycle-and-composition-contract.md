---
okf_version: 0.2
title: "TN-094: Specify platform-view lifecycle and composition contract"
summary: "Creation, layout, z-order, clipping, input, accessibility, surface loss, and destruction are explicit."
type: issue
status: ready
issue_id: "TN-094"
milestone: "M5"
...
# TN-094 — Specify platform-view lifecycle and composition contract
...
| Priority | P0 |
| Dependencies | TN-043, TN-044, TN-047, TN-081, TN-089 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Creation, layout, z-order, clipping, input, accessibility, surface loss, and destruction are explicit.
...
[TN-043](tn-043-implement-ios-skia-gpu-surface-and-lifecycle.md), [TN-044](tn-044-implement-android-skia-gpu-surface-and-fallback-policy.md), [TN-047](tn-047-implement-hit-testing-across-transforms-and-clips.md), [TN-081](tn-081-implement-native-focus-tree-scopes-traversal-and-restoration.md), [TN-089](tn-089-implement-semantics-node-model-and-scene-projection.md)
...
2. Write a short implementation note that states how this issue will produce: **Creation, layout, z-order, clipping, input, accessibility, surface loss, and destruction are explicit.**
...
- [ ] **Primary outcome:** Creation, layout, z-order, clipping, input, accessibility, surface loss, and destruction are explicit.
