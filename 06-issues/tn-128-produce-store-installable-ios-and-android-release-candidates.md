---
okf_version: 0.2
title: "TN-128: Produce store-installable iOS and Android release candidates"
summary: "Signed release candidates install, launch, upgrade, and report symbols correctly."
type: issue
status: ready
issue_id: "TN-128"
milestone: "M7"
...
# TN-128 — Produce store-installable iOS and Android release candidates
...
| Priority | P0 |
| Dependencies | TN-102, TN-103, TN-114, TN-123, TN-127 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Signed release candidates install, launch, upgrade, and report symbols correctly.
...
[TN-102](tn-102-implement-ios-framework-packaging-symbols-and-sample-app-assembly.md), [TN-103](tn-103-implement-android-library-packaging-symbols-and-sample-app-assembly.md), [TN-114](tn-114-complete-threat-model-release-mode-hardening-and-capability-audit.md), [TN-123](tn-123-freeze-package-boundaries-versioning-and-compatibility-policy.md), [TN-127](tn-127-close-performance-and-memory-acceptance-budgets.md)
...
2. Write a short implementation note that states how this issue will produce: **Signed release candidates install, launch, upgrade, and report symbols correctly.**
...
- [ ] **Primary outcome:** Signed release candidates install, launch, upgrade, and report symbols correctly.
...
- [ ] Physical iOS device test; simulator-only evidence is insufficient.
- [ ] Background/foreground and disposal lifecycle test.
- [ ] Physical Android device test; emulator-only evidence is insufficient.
- [ ] Configuration/lifecycle recreation test.
