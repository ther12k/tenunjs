---
okf_version: 0.2
title: "TN-063: Implement stack navigation and screen lifecycle"
summary: "Push, replace, pop, modal, load, pause, resume, and dispose behavior is deterministic."
type: issue
status: ready
issue_id: "TN-063"
milestone: "M3"
...
# TN-063 — Implement stack navigation and screen lifecycle
...
| Priority | P0 |
| Dependencies | TN-058, TN-060, TN-062 |
...
[TN-058](tn-058-implement-cancellable-async-effects-and-concurrency-policies.md), [TN-060](tn-060-implement-split-controller-view-screen-normalization.md), [TN-062](tn-062-specify-typed-route-and-navigation-state-model.md)
...
2. Write a short implementation note that states how this issue will produce: **Push, replace, pop, modal, load, pause, resume, and dispose behavior is deterministic.**
...
- [ ] **Primary outcome:** Push, replace, pop, modal, load, pause, resume, and dispose behavior is deterministic.
