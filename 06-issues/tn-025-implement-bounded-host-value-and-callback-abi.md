---
okf_version: 0.2
title: "TN-025: Implement bounded host value and callback ABI"
summary: "Typed value codec and callback handles without arbitrary pointers or JSON-per-property traffic."
type: issue
status: ready
issue_id: "TN-025"
milestone: "M1"
...
# TN-025 — Implement bounded host value and callback ABI
...
| Priority | P0 |
| Dependencies | TN-018, TN-024 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Typed value codec and callback handles without arbitrary pointers or JSON-per-property traffic.
...
[TN-018](tn-018-create-selected-native-engine-build-workspace.md), [TN-024](tn-024-implement-native-runtime-host-lifecycle.md)
...
2. Write a short implementation note that states how this issue will produce: **Typed value codec and callback handles without arbitrary pointers or JSON-per-property traffic.**
...
- [ ] **Primary outcome:** Typed value codec and callback handles without arbitrary pointers or JSON-per-property traffic.
