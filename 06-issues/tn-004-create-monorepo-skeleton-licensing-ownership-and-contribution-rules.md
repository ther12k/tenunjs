...
# TN-004 — Create monorepo skeleton, licensing, ownership, and contribution rules
...
| Priority | P0 |
| Dependencies | TN-001, TN-002 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Buildable empty workspace with ownership and legal metadata.
...
[TN-001](tn-001-clear-product-name-package-scope-and-repository-identity.md), [TN-002](tn-002-freeze-product-charter-target-workload-and-non-goals.md)
...
2. Write a short implementation note that states how this issue will produce: **Buildable empty workspace with ownership and legal metadata.**
...
- [ ] **Primary outcome:** Buildable empty workspace with ownership and legal metadata.
