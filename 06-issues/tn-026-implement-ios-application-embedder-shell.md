---
okf_version: 0.2
title: "TN-026: Implement iOS application embedder shell"
summary: "UIKit/Swift application launches, owns surface lifecycle, and hosts the selected engine."
type: issue
status: ready
issue_id: "TN-026"
milestone: "M1"
...
# TN-026 — Implement iOS application embedder shell
...
| Priority | P0 |
| Dependencies | TN-003, TN-018 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

UIKit/Swift application launches, owns surface lifecycle, and hosts the selected engine.
...
[TN-003](tn-003-define-supported-ios-and-android-baseline-matrix.md), [TN-018](tn-018-create-selected-native-engine-build-workspace.md)
...
2. Write a short implementation note that states how this issue will produce: **UIKit/Swift application launches, owns surface lifecycle, and hosts the selected engine.**
...
- [ ] **Primary outcome:** UIKit/Swift application launches, owns surface lifecycle, and hosts the selected engine.
