---
okf_version: 0.2
title: "TN-121: Migrate pilot vertical slices and record framework gaps"
summary: "Representative production journeys run on both platforms with issue-backed gaps."
type: issue
status: ready
issue_id: "TN-121"
milestone: "M7"
...
# TN-121 — Migrate pilot vertical slices and record framework gaps
...
| Priority | P0 |
| Dependencies | TN-119, TN-120 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Representative production journeys run on both platforms with issue-backed gaps.
...
[TN-119](tn-119-build-full-reference-business-application.md), [TN-120](tn-120-select-and-instrument-a-real-pilot-application.md)
...
2. Write a short implementation note that states how this issue will produce: **Representative production journeys run on both platforms with issue-backed gaps.**
...
- [ ] **Primary outcome:** Representative production journeys run on both platforms with issue-backed gaps.
