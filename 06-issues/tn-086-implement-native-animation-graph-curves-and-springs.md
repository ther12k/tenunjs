---
okf_version: 0.2
title: "TN-086: Implement native animation graph, curves, and springs"
summary: "Supported values animate on the native frame clock with cancellation and completion semantics."
type: issue
status: ready
issue_id: "TN-086"
milestone: "M4"
...
# TN-086 — Implement native animation graph, curves, and springs
...
| Priority | P0 |
| Dependencies | TN-048, TN-068 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Supported values animate on the native frame clock with cancellation and completion semantics.
...
[TN-048](tn-048-implement-frame-scheduler-and-immutable-frame-snapshots.md), [TN-068](tn-068-implement-theme-tokens-and-inherited-widget-context.md)
...
2. Write a short implementation note that states how this issue will produce: **Supported values animate on the native frame clock with cancellation and completion semantics.**
...
- [ ] **Primary outcome:** Supported values animate on the native frame clock with cancellation and completion semantics.
