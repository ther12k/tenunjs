---
okf_version: 0.2
title: "TN-092: Implement text scaling, high-contrast inputs, and reduced-motion policy"
summary: "System accessibility settings affect layout, theme, and motion without critical clipping."
type: issue
status: ready
issue_id: "TN-092"
milestone: "M5"
...
# TN-092 — Implement text scaling, high-contrast inputs, and reduced-motion policy
...
| Priority | P0 |
| Dependencies | TN-068, TN-075, TN-086, TN-089, TN-090, TN-091 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

System accessibility settings affect layout, theme, and motion without critical clipping.
...
[TN-068](tn-068-implement-theme-tokens-and-inherited-widget-context.md), [TN-075](tn-075-implement-text-shaping-paragraph-layout-and-font-fallback-service.md), [TN-086](tn-086-implement-native-animation-graph-curves-and-springs.md), [TN-089](tn-089-implement-semantics-node-model-and-scene-projection.md), [TN-090](tn-090-implement-ios-voiceover-bridge-and-focus-synchronization.md), [TN-091](tn-091-implement-android-talkback-bridge-and-focus-synchronization.md)
...
2. Write a short implementation note that states how this issue will produce: **System accessibility settings affect layout, theme, and motion without critical clipping.**
...
- [ ] **Primary outcome:** System accessibility settings affect layout, theme, and motion without critical clipping.
