---
okf_version: 0.2
title: "TN-007: Implement C++20 iOS and Android Skia vertical slice"
summary: "C++ candidate renders TSX-driven text/button, handles touch, and produces symbolized device evidence."
type: issue
status: ready
issue_id: "TN-007"
milestone: "M0"
...
# TN-007 — Implement C++20 iOS and Android Skia vertical slice
...
| Priority | P0 |
| Dependencies | TN-005, TN-006 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

C++ candidate renders TSX-driven text/button, handles touch, and produces symbolized device evidence.
...
[TN-005](tn-005-create-architecture-spike-benchmark-and-evidence-harness.md), [TN-006](tn-006-freeze-the-minimal-native-engine-and-embedder-spike-contract.md)
...
2. Write a short implementation note that states how this issue will produce: **C++ candidate renders TSX-driven text/button, handles touch, and produces symbolized device evidence.**
...
- [ ] **Primary outcome:** C++ candidate renders TSX-driven text/button, handles touch, and produces symbolized device evidence.
