---
okf_version: 0.2
title: "TN-037: Implement fail-closed native transaction validator"
summary: "Malformed sizes, opcodes, node graphs, props, and generations are rejected before mutation."
type: issue
status: ready
issue_id: "TN-037"
milestone: "M2"
...
# TN-037 — Implement fail-closed native transaction validator
...
| Priority | P0 |
| Dependencies | TN-033, TN-035 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Malformed sizes, opcodes, node graphs, props, and generations are rejected before mutation.
...
[TN-033](tn-033-implement-generation-safe-node-ids-and-arenas.md), [TN-035](tn-035-specify-mutation-transaction-binary-format.md)
...
2. Write a short implementation note that states how this issue will produce: **Malformed sizes, opcodes, node graphs, props, and generations are rejected before mutation.**
...
- [ ] **Primary outcome:** Malformed sizes, opcodes, node graphs, props, and generations are rejected before mutation.
