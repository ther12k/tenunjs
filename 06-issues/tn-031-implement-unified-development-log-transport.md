---
okf_version: 0.2
title: "TN-031: Implement unified development log transport"
summary: "CLI receives ordered JS, engine, renderer, and platform logs with source ownership."
type: issue
status: ready
issue_id: "TN-031"
milestone: "M1"
...
# TN-031 — Implement unified development log transport
...
| Priority | P1 |
| Dependencies | TN-028, TN-029, TN-030 |
| Suggested size | One focused worktree and PR |
| Gate impact | Required supporting work |

## Required outcome

CLI receives ordered JS, engine, renderer, and platform logs with source ownership.
...
[TN-028](tn-028-load-and-execute-a-verified-application-bundle-on-ios.md), [TN-029](tn-029-load-and-execute-a-verified-application-bundle-on-android.md), [TN-030](tn-030-implement-cross-layer-structured-error-codes-and-crash-boundaries.md)
...
2. Write a short implementation note that states how this issue will produce: **CLI receives ordered JS, engine, renderer, and platform logs with source ownership.**
...
- [ ] **Primary outcome:** CLI receives ordered JS, engine, renderer, and platform logs with source ownership.
