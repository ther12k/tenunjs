---
okf_version: 0.2
title: "TN-006: Freeze the minimal native engine and embedder spike contract"
summary: "One exact vertical-slice contract shared by all engine-language candidates."
type: issue
status: ready
issue_id: "TN-006"
milestone: "M0"
...
# TN-006 — Freeze the minimal native engine and embedder spike contract
...
| Priority | P0 |
| Dependencies | TN-002, TN-003 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

One exact vertical-slice contract shared by all engine-language candidates.
...
[TN-002](tn-002-freeze-product-charter-target-workload-and-non-goals.md), [TN-003](tn-003-define-supported-ios-and-android-baseline-matrix.md)
...
2. Write a short implementation note that states how this issue will produce: **One exact vertical-slice contract shared by all engine-language candidates.**
...
- [ ] **Primary outcome:** One exact vertical-slice contract shared by all engine-language candidates.
