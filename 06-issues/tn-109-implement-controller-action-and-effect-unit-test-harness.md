---
okf_version: 0.2
title: "TN-109: Implement controller, action, and effect unit-test harness"
summary: "Tests use deterministic services, cancellation, time, and action traces without devices."
type: issue
status: ready
issue_id: "TN-109"
milestone: "M6"
...
# TN-109 — Implement controller, action, and effect unit-test harness
...
| Priority | P0 |
| Dependencies | TN-055, TN-056, TN-058 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Tests use deterministic services, cancellation, time, and action traces without devices.
...
[TN-055](tn-055-implement-controller-definition-and-typed-state-initialization.md), [TN-056](tn-056-implement-typed-action-definition-and-dispatch.md), [TN-058](tn-058-implement-cancellable-async-effects-and-concurrency-policies.md)
...
2. Write a short implementation note that states how this issue will produce: **Tests use deterministic services, cancellation, time, and action traces without devices.**
...
- [ ] **Primary outcome:** Tests use deterministic services, cancellation, time, and action traces without devices.
