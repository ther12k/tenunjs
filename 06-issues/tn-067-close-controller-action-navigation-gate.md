---
okf_version: 0.2
title: "TN-067: Close controller-action-navigation gate"
summary: "One- and split-file apps complete typed interactive navigation journeys on both platforms."
type: issue
status: ready
issue_id: "TN-067"
milestone: "M3"
...
# TN-067 — Close controller-action-navigation gate
...
| Priority | P0 |
| Dependencies | TN-051, TN-052, TN-057, TN-058, TN-059, TN-060, TN-061, TN-063, TN-064, TN-065, TN-066 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

One- and split-file apps complete typed interactive navigation journeys on both platforms.
...
[TN-051](tn-051-implement-function-widget-execution-and-child-normalization.md), [TN-052](tn-052-implement-keyed-reconciliation-identity-rules.md), [TN-057](tn-057-implement-atomic-controller-state-transactions.md), [TN-058](tn-058-implement-cancellable-async-effects-and-concurrency-policies.md), [TN-059](tn-059-implement-one-file-screen-tsx-normalization.md), [TN-060](tn-060-implement-split-controller-view-screen-normalization.md), [TN-061](tn-061-implement-controller-and-widget-error-boundaries.md), [TN-063](tn-063-implement-stack-navigation-and-screen-lifecycle.md), [TN-064](tn-064-implement-deep-link-parsing-and-invalid-route-policy.md), [TN-065](tn-065-implement-android-back-and-ios-interactive-navigation-hooks.md), [TN-066](tn-066-implement-versioned-navigation-and-controller-state-restoration.md)
...
2. Write a short implementation note that states how this issue will produce: **One- and split-file apps complete typed interactive navigation journeys on both platforms.**
...
- [ ] **Primary outcome:** One- and split-file apps complete typed interactive navigation journeys on both platforms.
