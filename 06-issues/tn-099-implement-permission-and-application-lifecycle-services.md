---
okf_version: 0.2
title: "TN-099: Implement permission and application lifecycle services"
summary: "Permission requests and foreground/background/memory events have typed, race-safe behavior."
type: issue
status: ready
issue_id: "TN-099"
milestone: "M5"
...
# TN-099 — Implement permission and application lifecycle services
...
| Priority | P0 |
| Dependencies | TN-026, TN-027, TN-097, TN-098 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Permission requests and foreground/background/memory events have typed, race-safe behavior.
...
[TN-026](tn-026-implement-ios-application-embedder-shell.md), [TN-027](tn-027-implement-android-application-embedder-shell.md), [TN-097](tn-097-specify-native-module-idl-and-compatibility-manifest.md), [TN-098](tn-098-generate-typescript-engine-swift-kotlin-and-mock-native-module-bindings.md)
...
2. Write a short implementation note that states how this issue will produce: **Permission requests and foreground/background/memory events have typed, race-safe behavior.**
...
- [ ] **Primary outcome:** Permission requests and foreground/background/memory events have typed, race-safe behavior.
