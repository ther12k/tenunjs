---
okf_version: 0.2
title: "TN-032: Close the executable runtime and embedder gate"
summary: "One TSX bundle runs deterministically on physical iOS and Android with reproducible evidence."
type: issue
status: ready
issue_id: "TN-032"
milestone: "M1"
...
# TN-032 — Close the executable runtime and embedder gate
...
| Priority | P0 |
| Dependencies | TN-020, TN-028, TN-029, TN-030, TN-031 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

One TSX bundle runs deterministically on physical iOS and Android with reproducible evidence.
...
[TN-020](tn-020-implement-custom-jsx-jsxs-fragment-runtime.md), [TN-028](tn-028-load-and-execute-a-verified-application-bundle-on-ios.md), [TN-029](tn-029-load-and-execute-a-verified-application-bundle-on-android.md), [TN-030](tn-030-implement-cross-layer-structured-error-codes-and-crash-boundaries.md), [TN-031](tn-031-implement-unified-development-log-transport.md)
...
2. Write a short implementation note that states how this issue will produce: **One TSX bundle runs deterministically on physical iOS and Android with reproducible evidence.**
...
- [ ] **Primary outcome:** One TSX bundle runs deterministically on physical iOS and Android with reproducible evidence.
