---
okf_version: 0.2
title: "TN-075: Implement text shaping, paragraph layout, and font fallback service"
summary: "Unicode, bidi, fallback, line breaking, scaling, truncation, and measurement fixtures pass."
type: issue
status: ready
issue_id: "TN-075"
milestone: "M4"
...
# TN-075 — Implement text shaping, paragraph layout, and font fallback service
...
| Priority | P0 |
| Dependencies | TN-041, TN-045, TN-068 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Unicode, bidi, fallback, line breaking, scaling, truncation, and measurement fixtures pass.
...
[TN-041](tn-041-implement-intrinsic-measurement-callbacks.md), [TN-045](tn-045-implement-skia-display-list-playback.md), [TN-068](tn-068-implement-theme-tokens-and-inherited-widget-context.md)
...
2. Write a short implementation note that states how this issue will produce: **Unicode, bidi, fallback, line breaking, scaling, truncation, and measurement fixtures pass.**
...
- [ ] **Primary outcome:** Unicode, bidi, fallback, line breaking, scaling, truncation, and measurement fixtures pass.
