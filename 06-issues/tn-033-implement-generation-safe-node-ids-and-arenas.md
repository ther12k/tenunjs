---
okf_version: 0.2
title: "TN-033: Implement generation-safe node IDs and arenas"
summary: "Stale node references fail closed and ownership is deterministic."
type: issue
status: ready
issue_id: "TN-033"
milestone: "M2"
...
# TN-033 — Implement generation-safe node IDs and arenas
...
| Priority | P0 |
| Dependencies | TN-018, TN-032 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Stale node references fail closed and ownership is deterministic.
...
[TN-018](tn-018-create-selected-native-engine-build-workspace.md), [TN-032](tn-032-close-the-executable-runtime-and-embedder-gate.md)
...
2. Write a short implementation note that states how this issue will produce: **Stale node references fail closed and ownership is deterministic.**
...
- [ ] **Primary outcome:** Stale node references fail closed and ownership is deterministic.
