---
okf_version: 0.2
title: "TN-042: Implement renderer-neutral display list"
summary: "Immutable bounded draw operations represent one frame without Skia pointers."
type: issue
status: ready
issue_id: "TN-042"
milestone: "M2"
...
# TN-042 — Implement renderer-neutral display list
...
| Priority | P0 |
| Dependencies | TN-034, TN-038 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Immutable bounded draw operations represent one frame without Skia pointers.
...
[TN-034](tn-034-implement-host-widget-kind-and-property-schema-registry.md), [TN-038](tn-038-implement-atomic-scene-tree-transaction-application.md)
...
2. Write a short implementation note that states how this issue will produce: **Immutable bounded draw operations represent one frame without Skia pointers.**
...
- [ ] **Primary outcome:** Immutable bounded draw operations represent one frame without Skia pointers.
