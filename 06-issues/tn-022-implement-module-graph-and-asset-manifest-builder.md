...
# TN-022 — Implement module graph and asset manifest builder
...
[TN-019](tn-019-create-typescript-package-workspace-and-strict-configuration.md), [TN-021](tn-021-implement-project-configuration-schema-and-loader.md)
...
2. Write a short implementation note that states how this issue will produce: **Deterministic application graph with assets, screens, capabilities, hashes, and source maps.**
