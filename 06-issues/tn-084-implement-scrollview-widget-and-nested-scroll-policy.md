---
okf_version: 0.2
title: "TN-084: Implement ScrollView widget and nested-scroll policy"
summary: "Viewport layout, clipping, focus reveal, keyboard insets, and nested gestures work consistently."
type: issue
status: ready
issue_id: "TN-084"
milestone: "M4"
...
# TN-084 — Implement ScrollView widget and nested-scroll policy
...
| Priority | P0 |
| Dependencies | TN-070, TN-071, TN-081, TN-083 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Viewport layout, clipping, focus reveal, keyboard insets, and nested gestures work consistently.
...
[TN-070](tn-070-implement-row-column-expanded-and-flexible-widgets.md), [TN-071](tn-071-implement-stack-positioned-align-and-center-widgets.md), [TN-081](tn-081-implement-native-focus-tree-scopes-traversal-and-restoration.md), [TN-083](tn-083-implement-native-scroll-node-and-platform-physics.md)
...
2. Write a short implementation note that states how this issue will produce: **Viewport layout, clipping, focus reveal, keyboard insets, and nested gestures work consistently.**
...
7. Define state machines and cancellation/ownership before binding callbacks.
8. Use deterministic event traces for nested, interrupted, and competing interactions.
9. Include the controlled JavaScript-stall test when work affects per-frame behavior.
...
- [ ] **Primary outcome:** Viewport layout, clipping, focus reveal, keyboard insets, and nested gestures work consistently.
