---
okf_version: 0.2
title: "TN-123: Freeze package boundaries, versioning, and compatibility policy"
summary: "Beta packages have explicit support windows, protocol compatibility, and deprecation rules."
type: issue
status: ready
issue_id: "TN-123"
milestone: "M7"
...
# TN-123 — Freeze package boundaries, versioning, and compatibility policy
...
Beta packages have explicit support windows, protocol compatibility, and deprecation rules.
...
[TN-122](tn-122-review-and-simplify-public-api-from-pilot-evidence.md)
...
2. Write a short implementation note that states how this issue will produce: **Beta packages have explicit support windows, protocol compatibility, and deprecation rules.**
...
- [ ] **Primary outcome:** Beta packages have explicit support windows, protocol compatibility, and deprecation rules.
