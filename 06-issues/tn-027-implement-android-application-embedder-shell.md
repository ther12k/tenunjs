---
okf_version: 0.2
title: "TN-027: Implement Android application embedder shell"
summary: "Kotlin application launches, owns surface lifecycle, and hosts the selected engine."
type: issue
status: ready
issue_id: "TN-027"
milestone: "M1"
...
# TN-027 — Implement Android application embedder shell
...
Kotlin application launches, owns surface lifecycle, and hosts the selected engine.
...
2. Write a short implementation note that states how this issue will produce: **Kotlin application launches, owns surface lifecycle, and hosts the selected engine.**
...
- [ ] **Primary outcome:** Kotlin application launches, owns surface lifecycle, and hosts the selected engine.
