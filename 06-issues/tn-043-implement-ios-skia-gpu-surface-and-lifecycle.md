---
okf_version: 0.2
title: "TN-043: Implement iOS Skia GPU surface and lifecycle"
summary: "Metal-backed surface handles resize, background, foreground, and context loss."
type: issue
status: ready
issue_id: "TN-043"
milestone: "M2"
...
# TN-043 — Implement iOS Skia GPU surface and lifecycle
...
| Priority | P0 |
| Dependencies | TN-026, TN-042 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Metal-backed surface handles resize, background, foreground, and context loss.
...
[TN-026](tn-026-implement-ios-application-embedder-shell.md), [TN-042](tn-042-implement-renderer-neutral-display-list.md)
...
2. Write a short implementation note that states how this issue will produce: **Metal-backed surface handles resize, background, foreground, and context loss.**
...
- [ ] **Primary outcome:** Metal-backed surface handles resize, background, foreground, and context loss.
