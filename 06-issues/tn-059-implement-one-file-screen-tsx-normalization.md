---
okf_version: 0.2
title: "TN-059: Implement one-file .screen.tsx normalization"
summary: "Single-file screens compile into the canonical manifest without a special runtime."
type: issue
status: ready
issue_id: "TN-059"
milestone: "M3"
...
# TN-059 — Implement one-file .screen.tsx normalization
...
| Priority | P0 |
| Dependencies | TN-022, TN-055, TN-056 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Single-file screens compile into the canonical manifest without a special runtime.
...
[TN-022](tn-022-implement-module-graph-and-asset-manifest-builder.md), [TN-055](tn-055-implement-controller-definition-and-typed-state-initialization.md), [TN-056](tn-056-implement-typed-action-definition-and-dispatch.md)
...
2. Write a short implementation note that states how this issue will produce: **Single-file screens compile into the canonical manifest without a special runtime.**
...
- [ ] **Primary outcome:** Single-file screens compile into the canonical manifest without a special runtime.
