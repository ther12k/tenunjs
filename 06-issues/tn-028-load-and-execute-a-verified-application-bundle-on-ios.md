---
okf_version: 0.2
title: "TN-028: Load and execute a verified application bundle on iOS"
summary: "Physical iOS device executes a signed/hashed bundle entrypoint and reports source-mapped errors."
type: issue
status: ready
issue_id: "TN-028"
milestone: "M1"
...
# TN-028 — Load and execute a verified application bundle on iOS
...
| Priority | P0 |
| Dependencies | TN-023, TN-024, TN-025, TN-026 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Physical iOS device executes a signed/hashed bundle entrypoint and reports source-mapped errors.
...
[TN-023](tn-023-implement-runtime-compatible-bundle-or-bytecode-compiler.md), [TN-024](tn-024-implement-native-runtime-host-lifecycle.md), [TN-025](tn-025-implement-bounded-host-value-and-callback-abi.md), [TN-026](tn-026-implement-ios-application-embedder-shell.md)
...
2. Write a short implementation note that states how this issue will produce: **Physical iOS device executes a signed/hashed bundle entrypoint and reports source-mapped errors.**
...
- [ ] **Primary outcome:** Physical iOS device executes a signed/hashed bundle entrypoint and reports source-mapped errors.
