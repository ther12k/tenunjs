---
okf_version: 0.2
title: "TN-111: Implement Skia golden rendering and controlled update workflow"
summary: "Cross-platform golden suites detect intentional and accidental visual changes with metadata."
type: issue
status: ready
issue_id: "TN-111"
milestone: "M6"
...
# TN-111 — Implement Skia golden rendering and controlled update workflow
...
| Priority | P1 |
| Dependencies | TN-045, TN-075, TN-110 |
| Suggested size | One focused worktree and PR |
| Gate impact | Required supporting work |

## Required outcome

Cross-platform golden suites detect intentional and accidental visual changes with metadata.
...
[TN-045](tn-045-implement-skia-display-list-playback.md), [TN-075](tn-075-implement-text-shaping-paragraph-layout-and-font-fallback-service.md), [TN-110](tn-110-implement-headless-reconciler-layout-scene-and-semantics-test-host.md)
...
2. Write a short implementation note that states how this issue will produce: **Cross-platform golden suites detect intentional and accidental visual changes with metadata.**
...
- [ ] **Primary outcome:** Cross-platform golden suites detect intentional and accidental visual changes with metadata.
