---
okf_version: 0.2
title: "TN-060: Implement split controller/view screen normalization"
summary: "Feature-local split sources compile into the identical manifest contract."
type: issue
status: ready
issue_id: "TN-060"
milestone: "M3"
...
# TN-060 — Implement split controller/view screen normalization
...
| Priority | P0 |
| Dependencies | TN-022, TN-055, TN-059 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Feature-local split sources compile into the identical manifest contract.
...
[TN-022](tn-022-implement-module-graph-and-asset-manifest-builder.md), [TN-055](tn-055-implement-controller-definition-and-typed-state-initialization.md), [TN-059](tn-059-implement-one-file-screen-tsx-normalization.md)
...
2. Write a short implementation note that states how this issue will produce: **Feature-local split sources compile into the identical manifest contract.**
...
- [ ] **Primary outcome:** Feature-local split sources compile into the identical manifest contract.
