---
okf_version: 0.2
title: "TN-002: Freeze product charter, target workload, and non-goals"
summary: "Accepted charter that prevents HTML/web, React compatibility, and premature desktop scope from entering v0.x."
type: issue
status: ready
issue_id: "TN-002"
milestone: "M0"
...
# TN-002 — Freeze product charter, target workload, and non-goals
...
Accepted charter that prevents HTML/web, React compatibility, and premature desktop scope from entering v0.x.
...
[TN-001](tn-001-clear-product-name-package-scope-and-repository-identity.md)
...
2. Write a short implementation note that states how this issue will produce: **Accepted charter that prevents HTML/web, React compatibility, and premature desktop scope from entering v0.x.**
...
- [ ] **Primary outcome:** Accepted charter that prevents HTML/web, React compatibility, and premature desktop scope from entering v0.x.
