---
okf_version: 0.2
title: "TN-036: Implement mutation encoder in TypeScript"
summary: "Deterministic typed-array encoder produces canonical transaction bytes."
type: issue
status: ready
issue_id: "TN-036"
milestone: "M2"
...
# TN-036 — Implement mutation encoder in TypeScript
...
| Priority | P0 |
| Dependencies | TN-020, TN-035 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Deterministic typed-array encoder produces canonical transaction bytes.
...
[TN-020](tn-020-implement-custom-jsx-jsxs-fragment-runtime.md), [TN-035](tn-035-specify-mutation-transaction-binary-format.md)
...
2. Write a short implementation note that states how this issue will produce: **Deterministic typed-array encoder produces canonical transaction bytes.**
...
- [ ] **Primary outcome:** Deterministic typed-array encoder produces canonical transaction bytes.
