---
okf_version: 0.2
title: "TN-101: Implement asset, font, locale, and application-service registration"
summary: "Application resources and services resolve deterministically through manifest-backed registries."
type: issue
status: ready
issue_id: "TN-101"
milestone: "M5"
...
# TN-101 — Implement asset, font, locale, and application-service registration
...
| Priority | P1 |
| Dependencies | TN-022, TN-046, TN-075, TN-093, TN-098 |
| Suggested size | One focused worktree and PR |
| Gate impact | Required supporting work |

## Required outcome

Application resources and services resolve deterministically through manifest-backed registries.
...
[TN-022](tn-022-implement-module-graph-and-asset-manifest-builder.md), [TN-046](tn-046-implement-image-resource-decode-upload-and-cache-lifecycle.md), [TN-075](tn-075-implement-text-shaping-paragraph-layout-and-font-fallback-service.md), [TN-093](tn-093-implement-locale-rtl-bidi-layout-and-localized-resource-hooks.md), [TN-098](tn-098-generate-typescript-engine-swift-kotlin-and-mock-native-module-bindings.md)
...
2. Write a short implementation note that states how this issue will produce: **Application resources and services resolve deterministically through manifest-backed registries.**
...
- [ ] **Primary outcome:** Application resources and services resolve deterministically through manifest-backed registries.
