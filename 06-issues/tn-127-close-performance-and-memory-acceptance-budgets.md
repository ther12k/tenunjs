---
okf_version: 0.2
title: "TN-127: Close performance and memory acceptance budgets"
summary: "Pilot and reference workloads meet declared physical-device budgets without hidden exclusions."
type: issue
status: ready
issue_id: "TN-127"
milestone: "M7"
...
# TN-127 — Close performance and memory acceptance budgets
...
| Priority | P0 |
| Dependencies | TN-121, TN-115, TN-116, TN-122 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Pilot and reference workloads meet declared physical-device budgets without hidden exclusions.
...
[TN-121](tn-121-migrate-pilot-vertical-slices-and-record-framework-gaps.md), [TN-115](tn-115-implement-physical-device-startup-frame-list-bridge-and-js-stall-benchmarks.md), [TN-116](tn-116-implement-memory-leak-lifecycle-and-long-run-soak-suite.md), [TN-122](tn-122-review-and-simplify-public-api-from-pilot-evidence.md)
...
2. Write a short implementation note that states how this issue will produce: **Pilot and reference workloads meet declared physical-device budgets without hidden exclusions.**
...
- [ ] **Primary outcome:** Pilot and reference workloads meet declared physical-device budgets without hidden exclusions.
