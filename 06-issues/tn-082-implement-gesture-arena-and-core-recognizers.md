---
okf_version: 0.2
title: "TN-082: Implement gesture arena and core recognizers"
summary: "Tap, long press, pan, scale, cancellation, and nested competition pass event traces."
type: issue
status: ready
issue_id: "TN-082"
milestone: "M4"
...
# TN-082 — Implement gesture arena and core recognizers
...
| Priority | P0 |
| Dependencies | TN-047, TN-073 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Tap, long press, pan, scale, cancellation, and nested competition pass event traces.
...
[TN-047](tn-047-implement-hit-testing-across-transforms-and-clips.md), [TN-073](tn-073-implement-pressable-button-iconbutton-and-interaction-states.md)
...
2. Write a short implementation note that states how this issue will produce: **Tap, long press, pan, scale, cancellation, and nested competition pass event traces.**
...
- [ ] **Primary outcome:** Tap, long press, pan, scale, cancellation, and nested competition pass event traces.
