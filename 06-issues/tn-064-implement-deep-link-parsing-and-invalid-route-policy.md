---
okf_version: 0.2
title: "TN-064: Implement deep-link parsing and invalid-route policy"
summary: "Untrusted links validate through typed route schemas and produce declared fallbacks."
type: issue
status: ready
issue_id: "TN-064"
milestone: "M3"
...
# TN-064 — Implement deep-link parsing and invalid-route policy
...
| Priority | P1 |
| Dependencies | TN-062, TN-063 |
| Suggested size | One focused worktree and PR |
| Gate impact | Required supporting work |

## Required outcome

Untrusted links validate through typed route schemas and produce declared fallbacks.
...
[TN-062](tn-062-specify-typed-route-and-navigation-state-model.md), [TN-063](tn-063-implement-stack-navigation-and-screen-lifecycle.md)
...
2. Write a short implementation note that states how this issue will produce: **Untrusted links validate through typed route schemas and produce declared fallbacks.**
...
- [ ] **Primary outcome:** Untrusted links validate through typed route schemas and produce declared fallbacks.
