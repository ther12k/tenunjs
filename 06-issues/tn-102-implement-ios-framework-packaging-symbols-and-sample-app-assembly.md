---
okf_version: 0.2
title: "TN-102: Implement iOS framework packaging, symbols, and sample app assembly"
summary: "Reusable iOS artifact and sample archive build without compiling engine dependencies in the app."
type: issue
status: ready
issue_id: "TN-102"
milestone: "M5"
...
# TN-102 — Implement iOS framework packaging, symbols, and sample app assembly
...
| Priority | P0 |
| Dependencies | TN-028, TN-043, TN-077, TN-090, TN-098 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Reusable iOS artifact and sample archive build without compiling engine dependencies in the app.
...
[TN-028](tn-028-load-and-execute-a-verified-application-bundle-on-ios.md), [TN-043](tn-043-implement-ios-skia-gpu-surface-and-lifecycle.md), [TN-077](tn-077-implement-ios-text-input-and-ime-adapter.md), [TN-090](tn-090-implement-ios-voiceover-bridge-and-focus-synchronization.md), [TN-098](tn-098-generate-typescript-engine-swift-kotlin-and-mock-native-module-bindings.md)
...
2. Write a short implementation note that states how this issue will produce: **Reusable iOS artifact and sample archive build without compiling engine dependencies in the app.**
...
- [ ] **Primary outcome:** Reusable iOS artifact and sample archive build without compiling engine dependencies in the app.
