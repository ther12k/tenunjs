---
okf_version: 0.2
title: "TN-069: Implement View, Text, Fragment, and Spacer host widgets"
summary: "Foundational semantic widgets render, layout, inspect, and diff correctly."
type: issue
status: ready
issue_id: "TN-069"
milestone: "M4"
...
# TN-069 — Implement View, Text, Fragment, and Spacer host widgets
...
| Priority | P0 |
| Dependencies | TN-041, TN-045, TN-053, TN-068 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Foundational semantic widgets render, layout, inspect, and diff correctly.
...
[TN-041](tn-041-implement-intrinsic-measurement-callbacks.md), [TN-045](tn-045-implement-skia-display-list-playback.md), [TN-053](tn-053-implement-property-diffing-and-event-handle-registration.md), [TN-068](tn-068-implement-theme-tokens-and-inherited-widget-context.md)
...
2. Write a short implementation note that states how this issue will produce: **Foundational semantic widgets render, layout, inspect, and diff correctly.**
...
- [ ] **Primary outcome:** Foundational semantic widgets render, layout, inspect, and diff correctly.
