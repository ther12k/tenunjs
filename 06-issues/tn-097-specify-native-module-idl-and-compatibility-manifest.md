---
okf_version: 0.2
title: "TN-097: Specify native module IDL and compatibility manifest"
summary: "Typed methods, events, errors, thread affinity, permissions, cancellation, and versions are canonical."
type: issue
status: ready
issue_id: "TN-097"
milestone: "M5"
...
# TN-097 — Specify native module IDL and compatibility manifest
...
| Priority | P0 |
| Dependencies | TN-025, TN-030 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Typed methods, events, errors, thread affinity, permissions, cancellation, and versions are canonical.
...
[TN-025](tn-025-implement-bounded-host-value-and-callback-abi.md), [TN-030](tn-030-implement-cross-layer-structured-error-codes-and-crash-boundaries.md)
...
2. Write a short implementation note that states how this issue will produce: **Typed methods, events, errors, thread affinity, permissions, cancellation, and versions are canonical.**
...
- [ ] **Primary outcome:** Typed methods, events, errors, thread affinity, permissions, cancellation, and versions are canonical.
