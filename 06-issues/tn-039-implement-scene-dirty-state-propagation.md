---
okf_version: 0.2
title: "TN-039: Implement scene dirty-state propagation"
summary: "Layout, paint, hit-test, and semantics dirtiness propagate independently and minimally."
type: issue
status: ready
issue_id: "TN-039"
milestone: "M2"
...
# TN-039 — Implement scene dirty-state propagation
...
Layout, paint, hit-test, and semantics dirtiness propagate independently and minimally.
...
[TN-038](tn-038-implement-atomic-scene-tree-transaction-application.md)
...
2. Write a short implementation note that states how this issue will produce: **Layout, paint, hit-test, and semantics dirtiness propagate independently and minimally.**
...
- [ ] **Primary outcome:** Layout, paint, hit-test, and semantics dirtiness propagate independently and minimally.
