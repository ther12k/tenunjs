---
okf_version: 0.2
title: "TN-085: Implement lazy ListView builder and recycling window"
summary: "Large logical lists materialize bounded rows while preserving keys, semantics, and focus."
type: issue
status: ready
issue_id: "TN-085"
milestone: "M4"
...
# TN-085 — Implement lazy ListView builder and recycling window
...
| Priority | P0 |
| Dependencies | TN-052, TN-069, TN-083, TN-084 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Large logical lists materialize bounded rows while preserving keys, semantics, and focus.
...
[TN-052](tn-052-implement-keyed-reconciliation-identity-rules.md), [TN-069](tn-069-implement-view-text-fragment-and-spacer-host-widgets.md), [TN-083](tn-083-implement-native-scroll-node-and-platform-physics.md), [TN-084](tn-084-implement-scrollview-widget-and-nested-scroll-policy.md)
...
2. Write a short implementation note that states how this issue will produce: **Large logical lists materialize bounded rows while preserving keys, semantics, and focus.**
...
- [ ] **Primary outcome:** Large logical lists materialize bounded rows while preserving keys, semantics, and focus.
