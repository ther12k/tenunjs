---
okf_version: 0.2
title: "TN-035: Specify mutation transaction binary format"
summary: "Versioned bounded operation format with fixtures and compatibility rules."
type: issue
status: ready
issue_id: "TN-035"
milestone: "M2"
...
# TN-035 — Specify mutation transaction binary format
...
| Priority | P0 |
| Dependencies | TN-025, TN-033, TN-034 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Versioned bounded operation format with fixtures and compatibility rules.
...
[TN-025](tn-025-implement-bounded-host-value-and-callback-abi.md), [TN-033](tn-033-implement-generation-safe-node-ids-and-arenas.md), [TN-034](tn-034-implement-host-widget-kind-and-property-schema-registry.md)
...
2. Write a short implementation note that states how this issue will produce: **Versioned bounded operation format with fixtures and compatibility rules.**
...
- [ ] **Primary outcome:** Versioned bounded operation format with fixtures and compatibility rules.
