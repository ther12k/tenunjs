---
okf_version: 0.2
title: "TN-010: Freeze the JavaScript runtime host adapter"
summary: "Runtime-neutral host interface, test fixtures, interruption rules, and bundle contract."
type: issue
status: ready
issue_id: "TN-010"
milestone: "M0"
...
# TN-010 — Freeze the JavaScript runtime host adapter
...
Runtime-neutral host interface, test fixtures, interruption rules, and bundle contract.
...
2. Write a short implementation note that states how this issue will produce: **Runtime-neutral host interface, test fixtures, interruption rules, and bundle contract.**
...
- [ ] **Primary outcome:** Runtime-neutral host interface, test fixtures, interruption rules, and bundle contract.
