---
okf_version: 0.2
title: "TN-081: Implement native focus tree, scopes, traversal, and restoration"
summary: "Touch, keyboard, modal, navigation, and accessibility focus have deterministic coordination."
type: issue
status: ready
issue_id: "TN-081"
milestone: "M4"
...
# TN-081 — Implement native focus tree, scopes, traversal, and restoration
...
| Priority | P0 |
| Dependencies | TN-047, TN-069, TN-073, TN-076 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Touch, keyboard, modal, navigation, and accessibility focus have deterministic coordination.
...
[TN-047](tn-047-implement-hit-testing-across-transforms-and-clips.md), [TN-069](tn-069-implement-view-text-fragment-and-spacer-host-widgets.md), [TN-073](tn-073-implement-pressable-button-iconbutton-and-interaction-states.md), [TN-076](tn-076-implement-editable-text-model-and-revision-protocol.md)
...
2. Write a short implementation note that states how this issue will produce: **Touch, keyboard, modal, navigation, and accessibility focus have deterministic coordination.**
...
- [ ] **Primary outcome:** Touch, keyboard, modal, navigation, and accessibility focus have deterministic coordination.
