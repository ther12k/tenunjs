---
okf_version: 0.2
title: "TN-049: Implement renderer mock and deterministic clock"
summary: "Engine tests run headlessly with inspectable display lists and time."
type: issue
status: ready
issue_id: "TN-049"
milestone: "M2"
...
# TN-049 — Implement renderer mock and deterministic clock
...
| Priority | P0 |
| Dependencies | TN-042, TN-048 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Engine tests run headlessly with inspectable display lists and time.
...
[TN-042](tn-042-implement-renderer-neutral-display-list.md), [TN-048](tn-048-implement-frame-scheduler-and-immutable-frame-snapshots.md)
...
2. Write a short implementation note that states how this issue will produce: **Engine tests run headlessly with inspectable display lists and time.**
...
- [ ] **Primary outcome:** Engine tests run headlessly with inspectable display lists and time.
