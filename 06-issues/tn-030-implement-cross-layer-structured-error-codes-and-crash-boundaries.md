---
okf_version: 0.2
title: "TN-030: Implement cross-layer structured error codes and crash boundaries"
summary: "Application, runtime, engine, renderer, and embedder failures are attributable and symbolized."
type: issue
status: ready
issue_id: "TN-030"
milestone: "M1"
...
# TN-030 — Implement cross-layer structured error codes and crash boundaries
...
| Priority | P0 |
| Dependencies | TN-024, TN-028, TN-029 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Application, runtime, engine, renderer, and embedder failures are attributable and symbolized.
...
[TN-024](tn-024-implement-native-runtime-host-lifecycle.md), [TN-028](tn-028-load-and-execute-a-verified-application-bundle-on-ios.md), [TN-029](tn-029-load-and-execute-a-verified-application-bundle-on-android.md)
...
2. Write a short implementation note that states how this issue will produce: **Application, runtime, engine, renderer, and embedder failures are attributable and symbolized.**
...
- [ ] **Primary outcome:** Application, runtime, engine, renderer, and embedder failures are attributable and symbolized.
