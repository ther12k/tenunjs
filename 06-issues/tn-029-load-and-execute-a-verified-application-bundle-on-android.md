---
okf_version: 0.2
title: "TN-029: Load and execute a verified application bundle on Android"
summary: "Physical Android device executes the same application artifact contract."
type: issue
status: ready
issue_id: "TN-029"
milestone: "M1"
...
# TN-029 — Load and execute a verified application bundle on Android
...
| Priority | P0 |
| Dependencies | TN-023, TN-024, TN-025, TN-027 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Physical Android device executes the same application artifact contract.
...
[TN-023](tn-023-implement-runtime-compatible-bundle-or-bytecode-compiler.md), [TN-024](tn-024-implement-native-runtime-host-lifecycle.md), [TN-025](tn-025-implement-bounded-host-value-and-callback-abi.md), [TN-027](tn-027-implement-android-application-embedder-shell.md)
...
2. Write a short implementation note that states how this issue will produce: **Physical Android device executes the same application artifact contract.**
...
- [ ] **Primary outcome:** Physical Android device executes the same application artifact contract.
