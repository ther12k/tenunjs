---
okf_version: 0.2
title: "TN-009: Score and select the initial native engine language"
summary: "Accepted ADR with weighted scorecard, risks, rollback path, and selected initial toolchain."
type: issue
status: ready
issue_id: "TN-009"
milestone: "M0"
...
# TN-009 — Score and select the initial native engine language
...
| Priority | P0 |
| Dependencies | TN-007, TN-008 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Accepted ADR with weighted scorecard, risks, rollback path, and selected initial toolchain.
...
[TN-007](tn-007-implement-c-20-ios-and-android-skia-vertical-slice.md), [TN-008](tn-008-implement-rust-ios-and-android-skia-vertical-slice.md)
...
2. Write a short implementation note that states how this issue will produce: **Accepted ADR with weighted scorecard, risks, rollback path, and selected initial toolchain.**
...
- [ ] **Primary outcome:** Accepted ADR with weighted scorecard, risks, rollback path, and selected initial toolchain.
