---
okf_version: 0.2
title: "TN-038: Implement atomic scene-tree transaction application"
summary: "Validated create/update/insert/move/remove/destroy operations commit atomically."
type: issue
status: ready
issue_id: "TN-038"
milestone: "M2"
...
# TN-038 — Implement atomic scene-tree transaction application
...
| Priority | P0 |
| Dependencies | TN-033, TN-034, TN-037 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Validated create/update/insert/move/remove/destroy operations commit atomically.
...
[TN-033](tn-033-implement-generation-safe-node-ids-and-arenas.md), [TN-034](tn-034-implement-host-widget-kind-and-property-schema-registry.md), [TN-037](tn-037-implement-fail-closed-native-transaction-validator.md)
...
2. Write a short implementation note that states how this issue will produce: **Validated create/update/insert/move/remove/destroy operations commit atomically.**
...
- [ ] **Primary outcome:** Validated create/update/insert/move/remove/destroy operations commit atomically.
