---
okf_version: 0.2
title: "TN-003: Define supported iOS and Android baseline matrix"
summary: "Explicit OS, CPU, GPU API, device, Xcode, Android Gradle, and NDK support matrix."
type: issue
status: ready
issue_id: "TN-003"
milestone: "M0"
...
# TN-003 — Define supported iOS and Android baseline matrix
...
Explicit OS, CPU, GPU API, device, Xcode, Android Gradle, and NDK support matrix.
...
[TN-002](tn-002-freeze-product-charter-target-workload-and-non-goals.md)
...
2. Write a short implementation note that states how this issue will produce: **Explicit OS, CPU, GPU API, device, Xcode, Android Gradle, and NDK support matrix.**
...
- [ ] **Primary outcome:** Explicit OS, CPU, GPU API, device, Xcode, Android Gradle, and NDK support matrix.
