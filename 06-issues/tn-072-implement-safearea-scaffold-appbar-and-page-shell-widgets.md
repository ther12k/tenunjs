---
okf_version: 0.2
title: "TN-072: Implement SafeArea, Scaffold, AppBar, and page shell widgets"
summary: "Insets and application shell behavior respond to platform/window changes."
type: issue
status: ready
issue_id: "TN-072"
milestone: "M4"
...
# TN-072 — Implement SafeArea, Scaffold, AppBar, and page shell widgets
...
| Priority | P0 |
| Dependencies | TN-043, TN-044, TN-068, TN-070 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Insets and application shell behavior respond to platform/window changes.
...
[TN-043](tn-043-implement-ios-skia-gpu-surface-and-lifecycle.md), [TN-044](tn-044-implement-android-skia-gpu-surface-and-fallback-policy.md), [TN-068](tn-068-implement-theme-tokens-and-inherited-widget-context.md), [TN-070](tn-070-implement-row-column-expanded-and-flexible-widgets.md)
...
2. Write a short implementation note that states how this issue will produce: **Insets and application shell behavior respond to platform/window changes.**
...
- [ ] **Primary outcome:** Insets and application shell behavior respond to platform/window changes.
