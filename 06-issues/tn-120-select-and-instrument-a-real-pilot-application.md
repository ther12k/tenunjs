---
okf_version: 0.2
title: "TN-120: Select and instrument a real pilot application"
summary: "Pilot scope, baseline metrics, risk owners, rollback, and privacy rules are recorded."
type: issue
status: ready
issue_id: "TN-120"
milestone: "M7"
...
# TN-120 — Select and instrument a real pilot application
...
Pilot scope, baseline metrics, risk owners, rollback, and privacy rules are recorded.
...
2. Write a short implementation note that states how this issue will produce: **Pilot scope, baseline metrics, risk owners, rollback, and privacy rules are recorded.**
...
- [ ] **Primary outcome:** Pilot scope, baseline metrics, risk owners, rollback, and privacy rules are recorded.
