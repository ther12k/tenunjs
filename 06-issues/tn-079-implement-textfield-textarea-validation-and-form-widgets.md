---
okf_version: 0.2
title: "TN-079: Implement TextField, TextArea, validation, and form widgets"
summary: "Typed fields expose labels, errors, submit actions, keyboard intent, and accessible state."
type: issue
status: ready
issue_id: "TN-079"
milestone: "M4"
...
# TN-079 — Implement TextField, TextArea, validation, and form widgets
...
| Priority | P0 |
| Dependencies | TN-056, TN-068, TN-076, TN-077, TN-078 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

Typed fields expose labels, errors, submit actions, keyboard intent, and accessible state.
...
[TN-056](tn-056-implement-typed-action-definition-and-dispatch.md), [TN-068](tn-068-implement-theme-tokens-and-inherited-widget-context.md), [TN-076](tn-076-implement-editable-text-model-and-revision-protocol.md), [TN-077](tn-077-implement-ios-text-input-and-ime-adapter.md), [TN-078](tn-078-implement-android-text-input-and-ime-adapter.md)
...
2. Write a short implementation note that states how this issue will produce: **Typed fields expose labels, errors, submit actions, keyboard intent, and accessible state.**
...
- [ ] **Primary outcome:** Typed fields expose labels, errors, submit actions, keyboard intent, and accessible state.
