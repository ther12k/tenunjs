---
okf_version: 0.2
title: "TN-106: Implement unified build, run, device, log, test, and package commands"
summary: "CLI orchestrates both platforms with stable exit codes and machine-readable diagnostics."
type: issue
status: ready
issue_id: "TN-106"
milestone: "M6"
...
# TN-106 — Implement unified build, run, device, log, test, and package commands
...
| Priority | P0 |
| Dependencies | TN-031, TN-105 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

CLI orchestrates both platforms with stable exit codes and machine-readable diagnostics.
...
[TN-031](tn-031-implement-unified-development-log-transport.md), [TN-105](tn-105-implement-create-tenun-and-project-generation-cli.md)
...
2. Write a short implementation note that states how this issue will produce: **CLI orchestrates both platforms with stable exit codes and machine-readable diagnostics.**
...
- [ ] **Primary outcome:** CLI orchestrates both platforms with stable exit codes and machine-readable diagnostics.
