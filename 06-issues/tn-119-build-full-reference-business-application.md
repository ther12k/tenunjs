---
okf_version: 0.2
title: "TN-119: Build full reference business application"
summary: "A non-trivial forms/lists/search/navigation/offline-error application exercises the public API."
type: issue
status: ready
issue_id: "TN-119"
milestone: "M7"
...
# TN-119 — Build full reference business application
...
A non-trivial forms/lists/search/navigation/offline-error application exercises the public API.
...
[TN-118](tn-118-close-public-alpha-release-gate.md)
...
2. Write a short implementation note that states how this issue will produce: **A non-trivial forms/lists/search/navigation/offline-error application exercises the public API.**
...
- [ ] **Primary outcome:** A non-trivial forms/lists/search/navigation/offline-error application exercises the public API.
