---
okf_version: 0.2
title: "TN-122: Review and simplify public API from pilot evidence"
summary: "Remove accidental complexity and record every beta-breaking API decision."
type: issue
status: ready
issue_id: "TN-122"
milestone: "M7"
...
# TN-122 — Review and simplify public API from pilot evidence
...
Remove accidental complexity and record every beta-breaking API decision.
...
[TN-121](tn-121-migrate-pilot-vertical-slices-and-record-framework-gaps.md)
...
2. Write a short implementation note that states how this issue will produce: **Remove accidental complexity and record every beta-breaking API decision.**
...
- [ ] **Primary outcome:** Remove accidental complexity and record every beta-breaking API decision.
