---
okf_version: 0.2
title: "TN-078: Implement Android text input and IME adapter"
summary: "InputConnection lifecycle, composition, selection, actions, autofill, and keyboard insets work on device."
type: issue
status: ready
issue_id: "TN-078"
milestone: "M4"
...
# TN-078 — Implement Android text input and IME adapter
...
| Priority | P0 |
| Dependencies | TN-027, TN-044, TN-076 |
| Suggested size | One focused worktree and PR |
| Gate impact | Milestone/gate critical |

## Required outcome

InputConnection lifecycle, composition, selection, actions, autofill, and keyboard insets work on device.
...
[TN-027](tn-027-implement-android-application-embedder-shell.md), [TN-044](tn-044-implement-android-skia-gpu-surface-and-fallback-policy.md), [TN-076](tn-076-implement-editable-text-model-and-revision-protocol.md)
...
2. Write a short implementation note that states how this issue will produce: **InputConnection lifecycle, composition, selection, actions, autofill, and keyboard insets work on device.**
...
- [ ] **Primary outcome:** InputConnection lifecycle, composition, selection, actions, autofill, and keyboard insets work on device.
